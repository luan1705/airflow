...
from utils.vimo.source_code.retail_sales import retail_sales, retail_sales_cal


with DAG(
    dag_id="vimo_retail_sales",
    default_args={
        "retries": 3,
    ...
    cal_retail_sales = PythonOperator(
        task_id="retail_sales_cal",
        python_callable=retail_sales_cal,
    )

    save_retail_sales >> cal_retail_sales