...
from utils.asset_foreign_history import save_all_foreign_today
...
with DAG(
    dag_id="asset_foreign_history_today",
    ...
    asset_foreign_history_today = PythonOperator(
    ...
    trigger_next = TriggerDagRunOperator(
        ...
        trigger_dag_id="asset_foreign_history_today",
        wait_for_completion=False,
    )

    asset_foreign_history_today >> gate_continue >> wait >> trigger_next