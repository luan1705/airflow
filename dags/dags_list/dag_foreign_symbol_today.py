...
from utils.foreign_history_symbol import save_all_foreign_today
...
with DAG(
    dag_id="save_foreign_symbol_today",
    ...
    # Task chính
    foreign_symbol_today = PythonOperator(
    ...
    trigger_next = TriggerDagRunOperator(
        ...
        trigger_dag_id="save_foreign_symbol_today",
        wait_for_completion=False,
        reset_dag_run=True,
    )

    foreign_symbol_today >> gate_continue >> trigger_next
