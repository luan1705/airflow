...
def get_yoy_col(ws) -> int:
    """Detect động cột YoY (cột đầu tiên có 'tháng' trong header, bỏ qua kỳ gốc và YTD)."""
    col_texts = {}
...
def upsert_cpi_yoy(df: pd.DataFrame):
...
def save_cpi_yoy(file_path: str):
    df = parse_cpi_yoy(file_path)
...
# def cpi_yoy(**context):
#     save_cpi_yoy("../../data/excel/2023_01.xlsx")

#=======================Chạy file chỉ định airflow=====================
# def cpi_yoy(**context):
#     save_cpi_yoy("/opt/airflow/dags/utils/vimo/data/excel/2026_01.xlsx")
