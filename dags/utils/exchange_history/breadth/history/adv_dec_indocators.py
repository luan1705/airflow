        ...
        with engine.begin() as conn:
            conn.execute(text(f"""
                CREATE TABLE IF NOT EXISTS exchange_history."{table}" (
                    ...
                    "above50Rsi14Pct"   DOUBLE PRECISION,
                    "above70Rsi14Pct"   DOUBLE PRECISION,
                    "below30Rsi14Pct"   DOUBLE PRECISION,
                    "positiveMacd50Pct"   DOUBLE PRECISION,
                    "positiveMacd100Pct"   DOUBLE PRECISION,
                    "above1WHighPct"    DOUBLE PRECISION,
                    "below1WLowPct"     DOUBLE PRECISION,
                    "above1MHighPct"    DOUBLE PRECISION,
                    "below1MLowPct"     DOUBLE PRECISION,
                    "above6MHighPct"    DOUBLE PRECISION,
                    "below6MLowPct"     DOUBLE PRECISION,
                    "above1YHighPct"    DOUBLE PRECISION,
                    "below1YLowPct"     DOUBLE PRECISION,
                    "above3YHighPct"    DOUBLE PRECISION,
                    "below3YLowPct"     DOUBLE PRECISION
                )
            """))
