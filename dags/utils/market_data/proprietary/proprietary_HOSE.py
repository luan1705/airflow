...
def proprietary_HOSE():
    try:
        ...
        propietary_ALL.to_sql(name='proprietary_HOSE',
                             schema='market_data',
                             con=enginedb,
                             if_exists='replace',
                             index=False
                            )
        logging.info('Đã lưu propietary_HOSE')
    except Exception as E:
        logging.exception('Lỗi lưu propietary_HOSE')
