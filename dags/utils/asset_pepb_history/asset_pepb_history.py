...
def calc_pepb(symbol: str):
    try:
        ...
        # Ngày thuộc quý chưa có BCTC → ép về quý mới nhất có dữ liệu
        mask = (close['yearReport'] > latest_year) | \
               ((close['yearReport'] == latest_year) & (close['lengthReport'] > latest_quarter))
