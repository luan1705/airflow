...
def foreign_history_1D(symbol,time,start=None,end=None):
    try:
        headers = {
        ...
        if not raw:
            ...
            if time=='months':
                ...
                data['tradingDate'] = data['tradingDate'].dt.strftime('%Y').astype('Int64')
            data [cols_amount+['foreignCurrentRoom']] = data [cols_amount+['foreignCurrentRoom']].astype('Int64')
